            ...
            <div class="scrolltext">
                <ul class="list-unstyled" id="notice-box">
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">本站正式启用新域名:<a href="https://www.datawisher.cn" target="_blank"><strong>https://www.datawisher.cn</strong></a></a>
                    </li>
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">2020年，打败新冠状病毒，中国加油！</a>
                    </li>
                </ul>
            </div>
        </div>
